...
CheckItem greater_than(int ref) {
...
#ifdef DEBUG
int main() {
    int ipt_age_1 = 10, ipt_age_2 = 18, ipt_age_3 = 80;
    
    CheckList age_filter = create_checklist(3, greater_than(18), less_than(100), equal(68));
